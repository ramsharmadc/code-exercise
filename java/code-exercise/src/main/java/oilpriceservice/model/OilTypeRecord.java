...
public class OilTypeRecord {
	...
	@Override
	public int hashCode() {
		return Objects.hash(getOilId(), getOilType(), getFixedRevenue(), getVariableRevenue(), getOilBarrelValue(),
				isActiveRecord());
	}

	@Override
	public String toString() {
		return "OilTypeRecord{" + "oilId='" + oilId + '\'' + ", oilType='" + oilType + '\'' + ", fixedRevenue="
				+ fixedRevenue + ", variableRevenue=" + variableRevenue + ", oilBarrelValue=" + oilBarrelValue
