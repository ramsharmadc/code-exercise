...
public class OneSuchArray {
	...
	public static void main(String[] args) {
		...
		System.out.println("Super Class of int array is :: " + arrPrimInts.getClass().getSuperclass());

		System.out.println(arr.getClass().getSuperclass() == arrPrimInts.getClass().getSuperclass());
