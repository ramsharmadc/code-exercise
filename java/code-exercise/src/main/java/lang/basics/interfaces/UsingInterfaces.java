...
public class UsingInterfaces extends lang.basics.interfaces.AbstractClass implements lang.basics.interfaces.SampleInterface {
	...
	public void methodTwo(String colour) {
		...
		System.out.println("The colour you mentioned is : " + colour.toString());
	}
