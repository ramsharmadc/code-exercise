package problemsolving.oilpriceservice.jpa.repository;
...
public class OilTypeTransactionDataRepository
        extends InMemoryJPARepository<OilTypeTransactionRecord> {

    private static final OilTypeTransactionDataRepository instance =
            new OilTypeTransactionDataRepository();
    private final Map<String, OilTypeTransactionRecord> oilTypesTransactionsData =
    ...
    public Map<Object, OilTypeTransactionRecord> fetchAll() {
        ...
        oilTypesTransactionsData.entrySet().stream()
