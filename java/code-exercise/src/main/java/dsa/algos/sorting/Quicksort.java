...
public class Quicksort {
    ...
    public static void main(String[] args) throws Exception {
        ...
        int[] arr = {10, 23, 7, 16, 90, 45/*
											 * , 10, 23, 7, 16, 90, 45, 10, 23, 7, 16, 90, 45, 10, 23, 7, 16, 90, 45,
											 * 10, 23, 7, 16, 90, 45, 10, 23, 7, 16, 90, 45, 10, 23, 7, 16, 90, 45, 10,
											 * 23, 7, 16, 90, 45, 10, 23, 7, 16, 90, 45, 10, 23, 7, 16, 90, 45, 10, 23,
											 * 7, 16, 90, 45
											 */};
        int left = 0;
