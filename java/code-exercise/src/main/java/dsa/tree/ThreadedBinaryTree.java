 ...
 * in-order traversal faster and do it without stack and without recursion. A
 ...
 * There are two types of threaded binary trees. Single Threaded: Where a NULL
 * right pointers is made to point to the in-order successor (if successor
 * exists) Double Threaded: Where both left and right NULL pointers are made to
 * point to in-order predecessor and in-order successor respectively. The
 * predecessor threads are useful for reverse in-order traversal and postorder
 * traversal.
 * 
 * @param <T>
 * @author lenovo
