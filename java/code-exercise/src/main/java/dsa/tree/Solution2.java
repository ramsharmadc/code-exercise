 ...
 * exists at least one subset in "A" such that doing a binary OR operation of
 * all the elements gives a value "X". Find the minimum number of elements that
 * should be removed from A such that no such subset exists.
 * 
 * @author ramsharma
 */
