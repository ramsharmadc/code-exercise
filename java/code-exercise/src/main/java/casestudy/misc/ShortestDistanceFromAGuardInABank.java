...
public class ShortestDistanceFromAGuardInABank {
     ...
     * open space, �G� represents guards and �W� represents walls in a Bank. Replace all of
     * the O�s in the matrix with their shortest distance from a guard, without being able to go
