...
/*
 * Problem //In this problem, you have to find the last three digits before the decimal point for the number
 * (3 + root(5))n. //For example, when n = 5, (3 + root(5))5 = 3935.73982... The answer is 935. //For n = 2,
 * (3 + root(5))2 = 27.4164079... The answer is 027.
 */
