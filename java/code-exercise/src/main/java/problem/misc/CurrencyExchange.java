...
/**
 * Given a list of currency exchange rates like this: EUR/USD => 1.2 USD/GBP =>
 * 0.75 GBP/AUD => 1.7 AUD/JPY => 90 GBP/JPY => 150 JPY/INR => 0.6
 * 
 * write a method double convert(String sourceCurrency, double amount, String
 * destCurrency); For example, convert(EUR, 100, INR)
 * 
