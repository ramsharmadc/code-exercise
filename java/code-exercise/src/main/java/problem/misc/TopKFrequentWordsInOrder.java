...
public class TopKFrequentWordsInOrder {
    ...
    public List<String> topKFrequent(String[] words, int k) {
        ...
        Queue<Map.Entry<String, Integer>> reverseWords = new PriorityQueue<>(
                (o1, o2) -> -1 * (o1.getValue() - o2.getValue()));
    ...
    public static void main(String[] args) {
        ...
        List<String> topKFrequentWordsInOrder = new TopKFrequentWordsInOrder().topKFrequent(words, 2);
