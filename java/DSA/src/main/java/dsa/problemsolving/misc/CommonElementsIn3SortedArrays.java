...
import dsa.algorithms.sorting.Quicksort;
import dsa.util.CommonUtils;

public class CommonElementsIn3SortedArrays {

    private static final int[] a = {5, 3, 8, 2, 9, 1};
    private static final int[] b = {15, 13, 5, 12, 19, 11};
    private static final int[] c = {25, 23, 5, 22, 29, 21};
