...
public class TestBankApplication {
    ...
    public void testWithdrawTxn() {
        BankTransaction withdrawBankTransaction = (BankTransaction) new WithdrawBankTransaction(200);
...
//            withdrawBankTransaction.apply(bankAccount);
    ...
    public void testDepositTxn() {
        BankTransaction depositBankTransaction = (BankTransaction) new DepositBankTransaction(200);
        try {
