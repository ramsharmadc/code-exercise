...
public class TestBankApplication {
    ...
    private practice.jpmctest.BankAccount bankAccount;
    private practice.jpmctest.TransactionExecutor transactionExecutor;

    @BeforeEach
    public void setup() {
        bankAccount = new practice.jpmctest.BankAccount(3000);
        transactionExecutor = new practice.jpmctest.TransactionExecutor();
    }
    ...
    public void testWithdrawTxn() {
        practice.jpmctest.BankTransaction withdrawBankTransaction = new practice.jpmctest.WithdrawBankTransaction(200);
