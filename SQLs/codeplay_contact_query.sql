...
LOCK TABLES `contact_query` WRITE;
/*!40000 ALTER TABLE `contact_query` DISABLE KEYS */;
INSERT INTO `contact_query` VALUES (1,'shramdc@gmail.com','Ram Sharma','hello','I want to connect',12345,'M');
...
-- Dump completed on 2019-12-14 20:11:38
